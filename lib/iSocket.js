...
// am going for it, am going to be using Redis for session management --- cross your fingers and hope Redis is free on Heroku
var RedisStore = require ("connect-redis") (connect);
var sessionStore = new RedisStore ({
    client: require('redis-url').connect (process.env.REDISTOGO_URL)
});

// this is our fail back plan --- with the leak and ERYthing
